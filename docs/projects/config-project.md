...
* Во вкладке "__Проверка фото__" подписать портреты учеников можно двумя способами:
    1.  __Вариант 1__: 
        + В первом фильтре выбрать "__Неизвестные портреты__", а затем нажать на первую фотографию.
        + В модальном окне справа от фото указать ученика, либо выбрав его из списка, либо создав новый аккаунт.
        + Последовательно повторить действие для всех фотографий фильтра.
    2.  __Вариант 2__: 
        + Нажать кнопку "__Подписать__", расположенную справа от фильтров.
        + Откроется модальное окно со всеми лицами, найденными на фотографиях с заданным фильтром.
        + Указать каждого ученика, либо выбрав его из списка, либо задава Фамилию и Имя.
        + Убрать отметки с найденных лиц, не являющихся учениками.
...
### Работа с группами
* Очень часто при продаже только фотографий съемку проводят не в отдельном классе или группе, а во всем учебном заведении. Подобные проекты обычно характеризуются:
...
* Для таких случаев предусмотрен дополнительный функционал, который используется в несколько этапов:
    1. __Формирование списка групп__
        + В разделе "__Участники__", нажимаем кнопку "__три точки__" и выбираем действие "__Настроить группы учеников__".
        + В открывшемся модальном окне задаем все группы или классы, которые принимали участие в съемках.
    2. __Распределение снимков по группам__
        + В разделе "__Проверка фото__", нажимаем кнопку "__три точки__" и выбираем действие "__Показать времся съемки__".
        + В первом фильтре выбираем значением "__Фото без группы__",  а затем включаем группировку фотографий по схожести через кнопку "__Группировка__".
        + Ориентируясь на время последовательно выбираем снимки одной группы, после чего переносим их нажатием кнопки "__Добавить в группу__".
        + Нажимаем кнопку "__Подписать__", в модальном окне нажимаем кнопку "__Сохранить__" без задания имен и фамилий.
    3. __Работа в личном кабинете__
        + В разделе "__Настройки__" в блоке "__Доступ в ЛК__" определяем способ входа в личный кабинет (часто для таких проектов используют "__Открытый доступ__").
        + Из блока "__Информация__" копируем ссылку доступа в ЛК и передаем __всем ученикам__.
        + Каждый ученик в процессе регистрации последовательно выбирает группу, портрет и задает фамилию + имя.
