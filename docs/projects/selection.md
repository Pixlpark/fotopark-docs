...
* В общем случае интерфейс раздела содержит несколько вкладок:
    ...
    + __Фото на общих разворотах__ - это снимки для общих разворотов. Вкладка будет отсутствовать, если в дизайне все развороты персональные.
    + __Фото по умолчанию__ - это снимки для персональных разворотов, которые будут использоваться если в настройках доступа в ЛК __запрещен выбор персональных фото__.
...
* ![](../_media/projects/selection-default.png)
...
* ![](../_media/projects/selection-errors.png)