...
* В случае использования стороннего приложения потребуется загрузить в него видео и фрагменты дизайнов альбомов, которые будут "оживать".
...
* Если используется встроенное приложение, то ничего дополнительно делать не нужно - сервис автоматически выгрузит в него необходимые данные.