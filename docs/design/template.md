...
* Для создания пресета необходимо:
    ...
    + На странице пресета отредактировать настройки в блоке "__Информация__". У нас подготовленны отдельные статьи по [размещению данных]/faq/settings#размещение-данных-в-дизайне() и [работе с цитатами](/faq/project-work#как-изменить-набор-цитат).
