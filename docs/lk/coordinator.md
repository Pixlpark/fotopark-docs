...
### Подпись фотографий
* Подпись портретных снимков позволяет соотнести ученика с набором фотографий, на которых он прирсутствует. Это в свою очередь облегчаем их отбор для персональных альбомов - вместо просмотра тысячи снимков можно будет выбирать из десятка со своим участием.
...
* Для согласования дизайнов необходимо выполнить следующие действия:
    ...
    + Перейти во вкоалку “__Дизайн альбома__“ и ознакомиться с дизайнов.
