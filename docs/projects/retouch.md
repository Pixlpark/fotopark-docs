...
* ![](../_media/projects/retouch-download.png)

## Обработка фотографий
* При пакетном скачивании все фотографии, выбранные в качестве общих портретов, персональных портретов или на обложку, будут находиться в одной папке с портретами, а остальные снимки - в другой. Таким образом выбранная портретная фотография для рамки с репортажем не будет в выгрузке находиться с папке с портретами. Исключением будет лишь случаей, если она выбрана и для фотопечати.
* После обработки файлов их необходимо загрузить обратно через кнопку “__Загрузить фото__”, не изменяя при этом их названия. Также допускается поштучное скачивание и замена снимков.
* ![](../_media/projects/retouch-upload.png)
...
* ![](../_media/projects/retouch-replace.png)
...
* ![](../_media/projects/retouch-check.png)