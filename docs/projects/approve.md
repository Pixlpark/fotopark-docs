...
## Проверка фотографом
* Перед печатью фотограф также проводит дополнительную проверку альбомов - либо в профиле каждого ученика, либо в отдельном разделе "__Подготовка к печати__".
