...
* __```[meta:table-frames]```  - группа для единственного в дизайне разворота с виньетками, который содержит всех учеников.   
* __```[meta:pages-frames]```  - группа для постраничного разворота с несколькими учениками, таких разворотов в дизайне используется несколько.
