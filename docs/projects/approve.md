---
title: 5. Утверждение альбомов
description: В данном разделе описан процесс проверки и утверждения альбомов
sidebar_position: 4
---

# 5. Утверждение альбомов
* Следующим этапом работы после обработки фотографий является "__Утверждение альбомов__", которое осуществляется через __личный кабинет__. Ученики могут проверять и утверждать только персональные альбомы, а координатор - как общий, так и персональные других учеников.
## Проверка учеником
* У каждого ученика в личном кабинете в разделе "__Утверждение альбома__" отображается готовый для печати макет альбома. Если по нему нет замечаний, необходимо подтвердить корректность альбома и нажать кнопку “__Утвердить__”. 
* Если по макету есть замечания, то потребуется внести правки:
    ...
    + Если функция редактирования недоступа, то внести правки в дизайн сможет лишь координатор. Если же в проекте отсутствует координатор, то замечания можно написать фотографу через раздел "__Мессенджер__".
![](../_media/projects/aproove-lk.png)

## Проверка координатором
* Участник проекта с ролью координатор отвечает за проверку и утверждение всех альбомов. Эта работа проводится также через разделе "__Утверждение альбомов__".
...
![](../_media/projects/aproove-coord.png)
...
* В сервисе предусмотрен автоматический перевод проекта в этот статус после утверждения последнего альбома. Саму проверку можно осуществлять либо в профиле каждого ученика, либо в разделе "__Подготовка к печати__".
* ![](../_media/projects/aproove-admin.png)
