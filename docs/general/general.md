...
* После создания проекта необходимо:
       + __Обязательно__: выбрать продукты и настроить для них дизайны
       + __Опционально__: сформировать списки учеников, задать дедлайны для смены статуса и отправки уведомлений, определить уровень доступа в личный кабинет
