...
### Добавление учеников
* После загрузки и проверки фотографий можно перейти к следующему действию - идентификации учеников на портретных снимках.
...
* Для подписи снимков необходимо:
    + Перейти во вкладку “__Подпись фото__” и нажать кнопку "__Подписать__".
    + В открывшемся модальном окне будут отображены все уникальные лица с фотографий заданного типа. По умолчанию поиск производиться по поретретным снимкам. Если их нет, то по репортажам. Можно как выбрать ученика из списка, так и задать его Фамилию и Имя. Если же поля оставить пустыми, то будут созданы аккаунты с наименованиями "Ученик 1", ... "Ученик N". В случаях, когда находятся лица, не являющиеся учениками, то нобходимо либо убрать персонажа из списка, либо удалить его отметку через кнопку "три точки".
    + После завершения работы над подписью учеников необходимо надать кнопку "__Сохранить__".
