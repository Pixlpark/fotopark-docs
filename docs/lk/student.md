...
### Регистрация в ЛК
* Для регистрации в личном кабинете вам будет представлена __ссылка доступа в ЛК или ссылка для регистрации в ЛК__. Рассмотрим ниже особенности их использования.
* При переходе по __ссылке доступа в ЛК__ регистрация произойдет автоматически и вы сразу попадете в личный кабинет. Последующий вход в личный кабинет нужен будет осуществлять только по этой ссылке.
* При переходе по __ссылке для регистрации в ЛК__ возможны разные сценарии регистрации. Рассмотрим наиболее популярный:
