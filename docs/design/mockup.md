...
### Общая информация
:::info[Информация]
Для удобства подготовки собственных макетов вы можете [скачать архив с примерами шаблонов для альбома и календаря-плаката](https://moyvipusknoy.ru/content/graduation_photobook_vertical_templates/vertical_templates.zip).
:::
...
### Специфика альбомов
* Т.к. технические требования к файлам для печати у различных типографий могу отличаться даже для близких или одинаковых форматов, мы разработали технологию адаптивного дизайна. Она позволяет подстраивать дизайн под любой формат книги следующим образом:
