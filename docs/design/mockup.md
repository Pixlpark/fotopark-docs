...
* Техническая особенность в подготовке универсальных макетов следующая:
    ...
    + Слои группы ```[page][align:left]``` вписываются в левую половину разворота без загиба, зоны обрезки и корешка.
    + Слои группы ```[page][align:right]``` размещаются в правой половине как в пункте выше.